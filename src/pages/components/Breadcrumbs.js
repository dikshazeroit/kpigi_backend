    ...
    <article>
      <Container className="px-0">
        ...
        <Documentation
          ...
          description={
            <p>
              Use the <code>&#x3C;Breadcrumb&#x3E;</code> component to show a clear navigational hierarchy 
              for your users. Using the <code>variant</code> props you can update the color.
            </p>
          }
    ...
    <Breadcrumb listProps={{ className: "breadcrumb-info breadcrumb-text-light text-white" }}>
      ...
      <Breadcrumb.Item active>Data</Breadcrumb.Item>
        ...
        <Documentation
          ...
          description={
            <p>
              To make breadcrumbs transparent, add the 
              <code>breadcrumb-transparent</code> class.
            </p>
          }
          scope={{ Row, Col, Breadcrumb }}
          imports={`import { Breadcrumb } from '@themesberg/react-bootstrap';`}
