...
import { faAngleDown, faAngleUp, faChartArea, faChartBar, faChartLine, faFlagUsa, faFolderOpen, faGlobeEurope, faPen, faPaperclip, faUserPlus } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <Card border="light" className="text-center p-0 mb-4 position-relative">
      ...
      <Card.Body className="pb-5">
        ...
        {/* Small Edit Icon at Bottom Right */}
        <FontAwesomeIcon
          icon={faPen}
