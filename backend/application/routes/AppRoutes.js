...
router.post( "/private/submit-kyc",combinedUpload, userObj.submitKyc);
...
router.post("/get-privacy-policy",faqObj.getPrivacyPolicies);
router.post("/get-terms-conditions", faqObj.getTermsConditions);
