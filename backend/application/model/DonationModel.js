...
const DonationSchema = new mongoose.Schema({
  ...
  d_fk_uc_uuid: { type: String, default: null },
  d_fk_f_uuid: { type: String, required: true },
  d_amount: { type: Number, required: true },
  ...
  d_payment_intent_id: { type: String, required: true }, // ✅ ADD THIS
